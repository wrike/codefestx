import 'dart:async';
import 'dart:convert';
import 'package:codefest/src/models/location.dart' as loc;
...
class ApiService extends MockClient {
  ...
  static List<loc.Location> _locationDb;
  ...
  static resetDb() {
    ...
    _locationDb = _initialLocations.map((json) => loc.Location.fromJson(json)).toList();
  }
